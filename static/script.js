...
function startSimulation() {
    ...
    const sliderNames = ["numSteps", "numAgents", "initialOutbreak", "virusSpreadRadius", "virusSpreadChance", "recoveryChance", "deathRate"];
    let values = [];
...
function resetSimulation() {
    ...
    const sliderNames = ["numSteps", "numAgents", "initialOutbreak", "virusSpreadRadius", "virusSpreadChance", "recoveryChance", "simulationSpeed", "deathRate"];
    const defaultValues = [10, 10, 1, 1, 0.4, 0.3, 3, 0.2];
    ...
    const numInfected = document.getElementById(`initialOutbreakSlider`).value;

    infectedCount = numInfected
    susceptibleCount = 10 - infectedCount
    resistantCount = 0
    deadCount = 0
...
function updateVisualization() {
    ...
    imgElement.src = 'static/simulation_visual_test.png?' + new Date().getTime();
